...
description: |
  Use this skill when Codex needs procedural guidance derived from README.md. Recast from the original README.md material as the orientation-guide procedure.
---
...
- Original Markdown: `README.md`
- Reformulated skill name: `orientation-guide`
