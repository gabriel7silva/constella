---
name: gsap-speed-playbook
description: |
  Use this skill when Codex needs official GSAP skill for performance — prefer transforms, avoid layout thrashing, will-change, batching. Reach for this when optimizing GSAP animations, reducing jank, or when the user asks about animation performance, FPS, or smooth 60fps. Recast from the original gsap-performance/SKILL.md material as the gsap-speed-playbook procedure.
---
...
- Original Markdown: `gsap-performance/SKILL.md`
- Reformulated skill name: `gsap-speed-playbook`
...
**Related skills:** Assemble animations with **gsap-core** (transforms, autoAlpha) and **gsap-timeline**; for ScrollTrigger performance see **gsap-scrolltrigger**.
...
- ❌ Produce hundreds of overlapping tweens or ScrollTriggers without testing on low-end devices.
