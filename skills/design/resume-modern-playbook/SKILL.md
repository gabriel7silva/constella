---
name: resume-modern-playbook
description: |
  Use this skill when Codex needs modern minimal resume, single A4 page, ready for print or PDF export. Recast from the original resume-modern/SKILL.md material as the resume-modern-playbook procedure.
---

# Resume Modern Playbook
...
- Original Markdown: `resume-modern/SKILL.md`
- Reformulated skill name: `resume-modern-playbook`
- Upstream reference: https://github.com/nexu-io/html-anything
- Source category: `resume`
