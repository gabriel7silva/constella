---
name: magazine-wine-rules-blueprint-quality-gate
description: |
  Use this skill when Codex needs procedural guidance derived from editorial-burgundy-principles-template/references/checklist.md. Recast from the original editorial-burgundy-principles-template/references/checklist.md material as the magazine-wine-rules-blueprint-quality-gate procedure.
---

# Magazine Wine Rules Blueprint Quality Gate
...
- Original Markdown: `editorial-burgundy-principles-template/references/checklist.md`
- Reformulated skill name: `magazine-wine-rules-blueprint-quality-gate`
