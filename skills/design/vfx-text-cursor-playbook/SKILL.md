---
name: vfx-text-cursor-playbook
description: |
  Use this skill when Codex needs cursor light trail, chromatic rays, and directional flares for word-by-word quote reveals in video intros. Recast from the original vfx-text-cursor/SKILL.md material as the vfx-text-cursor-playbook procedure.
---

# Vfx Text Cursor Playbook
...
- Original Markdown: `vfx-text-cursor/SKILL.md`
- Reformulated skill name: `vfx-text-cursor-playbook`
