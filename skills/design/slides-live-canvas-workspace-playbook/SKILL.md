---
name: slides-live-canvas-workspace-playbook
description: |
  Use this skill when Codex needs locked 1920x1080 canvas deck with React component-level free composition, not bound to a fixed template. Recast from the original deck-open-slide-canvas/SKILL.md material as the slides-live-canvas-workspace-playbook procedure.
---

# Slides Live Canvas Workspace Playbook
...
- Original Markdown: `deck-open-slide-canvas/SKILL.md`
- Reformulated skill name: `slides-live-canvas-workspace-playbook`
