---
name: interface-composition-playbook
description: |
  Use this skill when Codex needs produce distinctive, production-grade frontend interfaces with strong visual direction, polished typography, considered layout, and working HTML/CSS/JS or framework code. Use for websites, landing pages, dashboards, React components, application screens, and UI beautification. Recast from the original frontend-design/SKILL.md material as the interface-composition-playbook procedure.
---

# Interface Composition Playbook
...
- Original Markdown: `frontend-design/SKILL.md`
- Reformulated skill name: `interface-composition-playbook`
- Upstream reference: https://github.com/anthropics/skills/tree/main/skills/frontend-design
...
Use this skill when the user asks to assemble or improve a frontend interface: a website, landing page, dashboard, application screen, HTML/CSS artifact, React/Vue/Svelte component, or a visual redesign of an existing UI.
...
2. Commit to one specific aesthetic direction.
   ...
   - Avoid generic AI defaults: purple-blue gradients, vague glass cards, interchangeable SaaS layouts, over-rounded cards, stock icon rows, and decorative blobs that avoid serve the interface.
...
3. Design the real interface, not a placeholder poster.
   ...
   - Keep workflows efficient for the target user. Dashboards and tools prefer to be scannable and dense enough for repeated use; marketing pages can be more expressive.

4. Assemble production-grade frontend code.
   - Prefer the repository's existing framework, component conventions, icons, tokens, and styling approach.
   - For standalone artifacts, produce self-contained HTML/CSS/JS unless the user asked for a framework.
...
5. Refine visual craft.
   ...
   - Color: produce a balanced palette with role clarity. Use accent color sparingly and deliberately.
   - Layout: use alignment, rhythm, density, and negative space intentionally. Avoid let cards, panels, or labels drift.
