---
name: document-paper-scroll-playbook
description: |
  Use this skill when Codex needs warm parchment canvas (#f5f4ed), monochrome ink-blue accent (#1B365D), one serif family, and editorial-grade typography. Recast from the original doc-kami-parchment/SKILL.md material as the document-paper-scroll-playbook procedure.
---

# Document Paper Scroll Playbook
...
- Original Markdown: `doc-kami-parchment/SKILL.md`
- Reformulated skill name: `document-paper-scroll-playbook`
