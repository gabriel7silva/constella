---
name: scene-light-flare-cinema-playbook
description: |
  Use this skill when Codex needs film light leaks, grain, 16:9 letterbox, and large serif type for cinematic openings or chapter cards. Recast from the original frame-light-leak-cinema/SKILL.md material as the scene-light-flare-cinema-playbook procedure.
---

# Scene Light Flare Cinema Playbook
...
- Original Markdown: `frame-light-leak-cinema/SKILL.md`
- Reformulated skill name: `scene-light-flare-cinema-playbook`
...
【文字】
- 中央或左下: 大字衬线 (Origin Serif Pro / Playfair Display / EB Garamond) 5-8vw, weight 500 italic; 颜色暖白 `#f5e9d6` 或 cream。
