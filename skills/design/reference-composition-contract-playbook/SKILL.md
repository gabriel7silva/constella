---
name: reference-composition-contract-playbook
description: |
  Use this skill when Codex needs turn vague taste, screenshots, URLs, product notes, or "make it feel like this" references into a grounded DESIGN.md plus an implementation handoff. Use it before prototypes, decks, redesigns, or image remix work when the user needs a reusable visual direction rather than a one-off prompt. Recast from the original reference-design-contract/SKILL.md material as the reference-composition-contract-playbook procedure.
---

# Reference Composition Contract Playbook
...
- Original Markdown: `reference-design-contract/SKILL.md`
- Reformulated skill name: `reference-composition-contract-playbook`
...
enough that a later prototype, deck, redesign, or image-remix execute can execute
without guessing.
...
3. `implementation-handoff.md` — concise assemble instructions for the next
   artifact-producing skill or coding agent.

If a preview is useful, also produce `example.html` as a small hand-built
contract preview. Avoid make it the main deliverable.
...
4. **Freeze the direction.** Choose one coherent visual stance. Avoid provide
...
7. **Write `implementation-handoff.md`.** Keep it short and operational:
   ...
   - "first artifact prefer to prove..." acceptance notes
8. **Verify.** Read `references/checklist.md` and satisfy every P0 gate
