---
name: resume-modern-sample-worked-sample
description: |
  Use this skill when Codex needs procedural guidance derived from resume-modern/example.md. Recast from the original resume-modern/example.md material as the resume-modern-sample-worked-sample procedure.
---

# Resume Modern Sample Worked Sample
...
- Original Markdown: `resume-modern/example.md`
- Reformulated skill name: `resume-modern-sample-worked-sample`
