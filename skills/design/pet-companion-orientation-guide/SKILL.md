---
name: pet-companion-orientation-guide
description: |
  Use this skill when Codex needs procedural guidance derived from hatch-pet/README.md. Recast from the original hatch-pet/README.md material as the pet-companion-orientation-guide procedure.
---

# Pet Companion Orientation Guide
...
- Original Markdown: `hatch-pet/README.md`
- Reformulated skill name: `pet-companion-orientation-guide`
...
- Any Open Design agent can execute the skill end-to-end without a network
  fetch, an extra install step, or an out-of-tree clone.
- The packaged desktop assemble can ship the skill as inert static assets
...
script CLIs), this copy needs to be re-synced by hand. Treat it as a frozen
