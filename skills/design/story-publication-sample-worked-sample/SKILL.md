---
name: story-publication-sample-worked-sample
description: |
  Use this skill when Codex needs procedural guidance derived from article-magazine/example.md. Recast from the original article-magazine/example.md material as the story-publication-sample-worked-sample procedure.
---

# Story Publication Sample Worked Sample
...
- Original Markdown: `article-magazine/example.md`
- Reformulated skill name: `story-publication-sample-worked-sample`
