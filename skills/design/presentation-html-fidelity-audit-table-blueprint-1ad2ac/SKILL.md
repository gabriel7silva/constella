---
name: presentation-html-fidelity-audit-table-blueprint-1ad2ac
description: |
  Use this skill when Codex needs procedural guidance derived from pptx-html-fidelity-audit/references/audit-table-template.md. Recast from the original pptx-html-fidelity-audit/references/audit-table-template.md material as the presentation-html-fidelity-audit-table-blueprint-1ad2ac procedure.
---

# Presentation Html Fidelity Audit Table Blueprint 1ad2ac
...
- Original Markdown: `pptx-html-fidelity-audit/references/audit-table-template.md`
- Reformulated skill name: `presentation-html-fidelity-audit-table-blueprint-1ad2ac`
