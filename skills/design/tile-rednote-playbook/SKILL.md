---
name: tile-rednote-playbook
description: |
  Use this skill when Codex needs xiaohongshu-style knowledge cards, arranged as a swipeable multi-card carousel. Recast from the original card-xiaohongshu/SKILL.md material as the tile-rednote-playbook procedure.
---

# Tile Rednote Playbook
...
- Original Markdown: `card-xiaohongshu/SKILL.md`
- Reformulated skill name: `tile-rednote-playbook`
