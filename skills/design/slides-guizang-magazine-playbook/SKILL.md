---
name: slides-guizang-magazine-playbook
description: |
  Use this skill when Codex needs editorial magazine meets e-ink: 10 layouts and 5 palettes (Ink, Indigo Porcelain, Forest Ink, Kraft Paper, Dune). Recast from the original deck-guizang-editorial/SKILL.md material as the slides-guizang-magazine-playbook procedure.
---

# Slides Guizang Magazine Playbook
...
- Original Markdown: `deck-guizang-editorial/SKILL.md`
- Reformulated skill name: `slides-guizang-magazine-playbook`
