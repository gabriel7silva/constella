---
name: mockup-device-3d-playbook
description: |
  Use this skill when Codex needs static iPhone and MacBook 3D-style showcase with real HTML embedded on screens, glass-lens refraction, and 360-degree turntable composition. Recast from the original mockup-device-3d/SKILL.md material as the mockup-device-3d-playbook procedure.
---

# Mockup Device 3D Playbook
...
- Original Markdown: `mockup-device-3d/SKILL.md`
- Reformulated skill name: `mockup-device-3d-playbook`
