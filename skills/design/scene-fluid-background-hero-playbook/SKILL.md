---
name: scene-fluid-background-hero-playbook
description: |
  Use this skill when Codex needs webGL-style fluid displacement background with a quote overlay, suited to video intros, landing heroes, or posters. Recast from the original frame-liquid-bg-hero/SKILL.md material as the scene-fluid-background-hero-playbook procedure.
---

# Scene Fluid Background Hero Playbook
...
- Original Markdown: `frame-liquid-bg-hero/SKILL.md`
- Reformulated skill name: `scene-fluid-background-hero-playbook`
- Upstream reference: https://github.com/nexu-io/html-anything
- Source category: `poster`
