---
name: answers-surface-playbook
description: |
  Use this skill when Codex needs a Frequently Asked Questions (FAQ) page with collapsible accordion sections, search functionality, and category filtering. Reach for this when the brief asks for "FAQ", "help center", "questions", or "support page". Recast from the original faq-page/SKILL.md material as the answers-surface-playbook procedure.
---

# Answers Surface Playbook
...
- Original Markdown: `faq-page/SKILL.md`
- Reformulated skill name: `answers-surface-playbook`
...
2. **Pick the domain** from the brief (e.g., SaaS product, e-commerce, service)
   ...
   - **Edge cases**:
     - If the brief provides fewer than 8 FAQs, ask for more content or compose
