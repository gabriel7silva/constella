---
name: slides-grid-global-playbook
description: |
  Use this skill when Codex needs 16-column grid, one saturated accent, and 22 locked layouts (Klein Blue, Lemon, Mint, Safety Orange). Recast from the original deck-swiss-international/SKILL.md material as the slides-grid-global-playbook procedure.
---

# Slides Grid Global Playbook
...
- Original Markdown: `deck-swiss-international/SKILL.md`
- Reformulated skill name: `slides-grid-global-playbook`
