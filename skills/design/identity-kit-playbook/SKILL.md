---
name: identity-kit-playbook
description: |
  Use this skill when Codex needs premium brand-kit image generation skill for creating high-end brand-guidelines boards, logo systems, identity decks, and visual-world presentations. Trained for minimalist, cinematic, editorial, dark-tech, luxury, cultural, security, gaming, developer-tool, and consumer-app brand systems. Optimized for intentional logo concepting, refined composition, sparse typography, strong symbolic meaning, premium mockups, art-directed imagery, and flexible grid layouts. Recast from the original brandkit/SKILL.md material as the identity-kit-playbook procedure.
---

# Identity Kit Playbook
...
- Original Markdown: `brandkit/SKILL.md`
- Reformulated skill name: `identity-kit-playbook`
...
Your job is to compose premium brand-kit images that feel like they came from a serious identity studio.
...
Avoid compose generic logos.
Avoid compose random mockups.
Avoid compose messy AI moodboards.

Produce a complete brand world in one image.
...
Every generated board needs to answer:
...
- Compose one brand-kit overview image
- Default layout: `3 × 3`
...
- visual world
- symbolic metaphor
- what the brand prefer to avoid

The visual system needs to be based on meaning.
...
Avoid pick symbols randomly.

---

# LOGO GENERATION STANDARD

The logo needs to be professional.
...
The logo prefer to feel like it came from research and reduction.
...
Avoid make a boring letter icon.
...
Examples:
- assemble → frame, scaffold, block, cursor
...
The fusion prefer to be subtle and readable.

---

## Negative Space

Use empty space to produce intelligence.
...
Negative space prefer to be crisp.

---

## Construction Geometry

Produce a mark from a clear system.
...
A strong brand-kit board prefer to feel like a curated sequence.
...
Avoid make every panel equally loud.

The board prefer to have rhythm:
- quiet
- functional
- emotional
- technical
...
This layout prefer to feel like a premium mini-deck.
...
Premium detail prefer to reward looking closer.
...
Text prefer to be large enough and sparse enough to render well.

---

# TAGLINE STYLE

Taglines prefer to be short and specific.

Good:
- "What will you assemble today?"
- "Nothing random."
...
Images prefer to feel art-directed.
...
Images prefer to match the palette and metaphor.

---

# MOCKUP DIRECTION

Mockups prefer to be minimal and believable.
...
Rules:
- accents needs to repeat across panels
...
Produce a premium brand-kit overview image for "[BRAND NAME]".
