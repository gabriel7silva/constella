---
name: scene-flow-notes
description: |
  Use this skill when Codex needs sVG curve connectors, sticky-note nodes, and cursor interaction with a whiteboard-brainstorm feel. Recast from the original frame-flowchart-sticky/SKILL.md material as the scene-flow-notes procedure.
---
...
- Original Markdown: `frame-flowchart-sticky/SKILL.md`
- Reformulated skill name: `scene-flow-notes`
