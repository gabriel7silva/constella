---
name: scene-mark-ending-playbook
description: |
  Use this skill when Codex needs segmented logo assembly, glow bloom, and tagline reveal for video outros or brand closing frames. Recast from the original frame-logo-outro/SKILL.md material as the scene-mark-ending-playbook procedure.
---

# Scene Mark Ending Playbook
...
- Original Markdown: `frame-logo-outro/SKILL.md`
- Reformulated skill name: `scene-mark-ending-playbook`
