---
name: field-journal-magazine-blueprint
description: |
  Use this skill when Codex needs editorial "Field Notes" report template with soft paper background, serif hero typography, rounded pastel insight cards, and a retention chart panel. Reach for this when users ask for a premium magazine-style business report, board memo one-pager, or elegant data storytelling layout. Recast from the original field-notes-editorial-template/SKILL.md material as the field-journal-magazine-blueprint procedure.
---

# Field Journal Magazine Blueprint
...
- Original Markdown: `field-notes-editorial-template/SKILL.md`
- Reformulated skill name: `field-journal-magazine-blueprint`
