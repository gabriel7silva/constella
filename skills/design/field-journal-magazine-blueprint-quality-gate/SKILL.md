---
name: field-journal-magazine-blueprint-quality-gate
description: |
  Use this skill when Codex needs procedural guidance derived from field-notes-editorial-template/references/checklist.md. Recast from the original field-notes-editorial-template/references/checklist.md material as the field-journal-magazine-blueprint-quality-gate procedure.
---

# Field Journal Magazine Blueprint Quality Gate
...
- Original Markdown: `field-notes-editorial-template/references/checklist.md`
- Reformulated skill name: `field-journal-magazine-blueprint-quality-gate`
...
- [ ] Single-file HTML output (`<!doctype html>`, inline CSS/JS, no assemble step).
