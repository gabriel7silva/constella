---
name: scene-macos-alert-playbook
description: |
  Use this skill when Codex needs realistic macOS notification banner with app icon, title, and body, suited to video overlays or product teasers. Recast from the original frame-macos-notification/SKILL.md material as the scene-macos-alert-playbook procedure.
---

# Scene Macos Alert Playbook
...
- Original Markdown: `frame-macos-notification/SKILL.md`
- Reformulated skill name: `scene-macos-alert-playbook`
