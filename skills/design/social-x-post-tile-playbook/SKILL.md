---
name: social-x-post-tile-playbook
description: |
  Use this skill when Codex needs realistic X post card with engagement metrics (likes, reposts, views), suited to video overlays or shareable image cards. Recast from the original social-x-post-card/SKILL.md material as the social-x-post-tile-playbook procedure.
---

# Social X Post Tile Playbook
...
- Original Markdown: `social-x-post-card/SKILL.md`
- Reformulated skill name: `social-x-post-tile-playbook`
