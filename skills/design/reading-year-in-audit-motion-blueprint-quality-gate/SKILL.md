---
name: reading-year-in-audit-motion-blueprint-quality-gate
description: |
  Use this skill when Codex needs procedural guidance derived from weread-year-in-review-video-template/references/checklist.md. Recast from the original weread-year-in-review-video-template/references/checklist.md material as the reading-year-in-audit-motion-blueprint-quality-gate procedure.
---

# Reading Year In Audit Motion Blueprint Quality Gate
...
- Original Markdown: `weread-year-in-review-video-template/references/checklist.md`
- Reformulated skill name: `reading-year-in-audit-motion-blueprint-quality-gate`
...
- Rendered MP4 is not blank: contact sheet needs to show visible content in all 12 scenes.
