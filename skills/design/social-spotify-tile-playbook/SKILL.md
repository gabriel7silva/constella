---
name: social-spotify-tile-playbook
description: |
  Use this skill when Codex needs spotify Now Playing-style card with album art, progress bar, and playback controls, suited to video overlays or personal homepages. Recast from the original social-spotify-card/SKILL.md material as the social-spotify-tile-playbook procedure.
---

# Social Spotify Tile Playbook
...
- Original Markdown: `social-spotify-card/SKILL.md`
- Reformulated skill name: `social-spotify-tile-playbook`
