---
name: release-journal-single-page-quality-gate
description: |
  Use this skill when Codex needs procedural guidance derived from release-notes-one-pager/references/checklist.md. Recast from the original release-notes-one-pager/references/checklist.md material as the release-journal-single-page-quality-gate procedure.
---

# Release Journal Single Page Quality Gate
...
- Original Markdown: `release-notes-one-pager/references/checklist.md`
- Reformulated skill name: `release-journal-single-page-quality-gate`
...
Execute this before emitting `<artifact>`. P0 = needs to pass; P1 = prefer to pass; P2 = nice to have.
...
- [ ] No placeholder tokens remain in href attributes: `[REPLACE]`, `REPLACE_WITH_REAL_URL`, or `https://example.com`. All hrefs needs to be valid URLs.
- [ ] CTA copy needs to accurately describe an available destination; avoid promise content that is not present.
