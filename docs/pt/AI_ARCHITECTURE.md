...
|-----------|---------|---------|
| `cli_claude_code` | `claude` | `opus`, `sonnet`, `haiku`, `fable` |
| `cli_codex` | `codex` | `gpt-6-astra`, `gpt-5.6-sol`, `gpt-5.6-terra`, `gpt-5.6-luna` |
...
| `cli_grok` | `grok` | `(default)`, `grok-4.6`, `grok-4.5`, `grok-build-0.1` |
...
```
codex exec --json --skip-git-repo-check -s workspace-write -m gpt-6-astra
```
